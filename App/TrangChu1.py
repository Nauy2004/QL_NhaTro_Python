...
from Apl import QuanLyDichVu, QuanLyNguoiThue, QuanLyPhongTro, QuanLyNhanVien, QuanLyHopDong, QuanLyHoaDon
...
buttons.extend([
    ...
    ttk.Button(frame_menu, text="Xem thông tin tài khoản", 
              command=lambda: subprocess.run(["python", "Apl/XemThongTin.py"])),
