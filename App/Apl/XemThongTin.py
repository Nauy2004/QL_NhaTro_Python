...
def XemThongTin(parent_frame, username, window):  # Thêm username và window làm tham số
    ...
    mo_cua_so_thong_tin_tai_khoan(username, window) #truyền username và window vào hàm này.
